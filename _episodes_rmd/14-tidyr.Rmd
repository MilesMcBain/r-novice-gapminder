...
These formats tend to be favoured in differnet situatuations. When modelling data, the standard is wide format, with a row repsenting a single observational unit and the columns representing different measurements. When plotting data, especially with ggplot2, the longer format is often useful since it allows the comparison of different measures or 'series' on the same plot by binding an ID variable to the colour or group aesthetic.
